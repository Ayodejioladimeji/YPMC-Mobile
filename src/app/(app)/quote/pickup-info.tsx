...
} from "@/components/quote/location-form";
...
export default function PickupInfoForm() {
  ...
  const [currentPlace, setCurrentPlace] = useState<LocationType | undefined>(
    undefined,
  );
  ...
  const form = useForm<z.infer<typeof schema>>({
    ...
    defaultValues: {
      ...
      scheduledType: orderData?.scheduledType || selected
    },
    mode: "onChange",
  });
          ...
          <Form {...form}>
            <View style={styles.wrapper}>
              ...
              <View>
                ...
                <RadioCheck selected={selected} setSelected={setSelected} />
