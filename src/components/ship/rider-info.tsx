...
import { handleDial } from "./dialNumber";
...
const RiderInfo = forwardRef<BottomSheetModal, RiderInfoProps>(
  ({ index, position }, ref) => {
    ...
    const { proposedRider: rider, shipping } = state
              ...
              <View>
                ...
                >
                  ...
                  <View style={{ marginTop: spacing.xs }}>
                    ...
                    >
                      {rider?.partner?.companyName || "YPMC Logistics"}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.textStyle}>
                  ...
                  <View>
                    <Text style={{ fontFamily: "interMedium", fontSize: 14 }}>
                      ₦{formatMoney(shipping?.actualPriceInNaira || shipping?.totalActualPriceInNaira || 0)}
                    </Text>
                  </View>
                </View>
